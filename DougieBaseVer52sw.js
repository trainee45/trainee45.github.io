/*DougieBaseVer52sw.js current published Mar1 2024 DougieBaseVer51sw.js published Jan22 2024 ADDED THIS CODE TO SW55: self.addEventListener('controllerchange', function(event) {
...
//  'demo.js'
 '/',//https://github.com/trainee45/trainee45.github.io',//directory path to project folder
       ...
       '/DougieBaseVer52.js',//directory path to project folder/app name.js file
       '/DougieBaseVer52.css',////directory path to project folder/app name.css file
	   '/smallDeviceDougieBaseVer52.css',//tested in Inspect Dec10 2021
...
//ADDED THIS CODE TO SW55 and it seems to update if you reboot from the app icon. Tap app icon, swipe DougieBase off top of screen, then tap app icon again and it updates! Date: Jan22 2024 ? I think it updates???
